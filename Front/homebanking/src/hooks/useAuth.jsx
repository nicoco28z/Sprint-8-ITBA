...
function useProvideAuth() {
  ...
  function signIn(user) {
    const usuario = { id: user.id, username: user.username, first_name: user.first_name, last_name: user.last_name, email: user.email, is_staff: user.is_staff, sucursal_id: user.sucursal_id, tipo_cliente_id: user.tipo_cliente_id };
